                                ...
                                <div class="col-md-12 col-sm-6">
                                    ...
                                    <div class="post post-list clearfix">
                                        <div class="thumb rounded">
                                            ...
                                            <a href="blog-single.html">
                                                <div class="inner">
                                                    <img src="{{ $latest->attachment_url }}" alt="post-title" />
                                                </div>
                                            </a>
                                        </div>
                                        <div class="details">
                                            <ul class="meta list-inline mb-3">
                                                <li class="list-inline-item"><a href="#"><img
                                                            src="{{ asset('') }}assets/images/other/author-sm.png"
                                                            class="author"
                                                            alt="author" />{{ optional($latest->creator)->name ?? '-' }}</a>
                                                </li>
                                                <li class="list-inline-item">{{ convert_date($latest->created_at) }}</li>
                                                {{-- <li class="list-inline-item"><a
                                                        href="#">{{ $latest->visitors->count() . ' views' }}</a>
                                                </li> --}}
                                            </ul>
                                            <h5 class="post-title"><a href="blog-single.html">{{ $latest->title }}</a>
                                            </h5>
                                            <p class="excerpt mb-0">A wonderful serenity has taken possession of my
                                                entire soul, like these sweet mornings</p>
                                            <div class="post-bottom clearfix d-flex align-items-start">
                                                <span><i class="fa fa-eye"
                                                        style="padding-right: 8px;"></i>{{ $latest->visitors->count() . ' views' }}</span>
