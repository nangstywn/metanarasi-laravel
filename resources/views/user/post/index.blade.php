        ...
        <div class="container-xl">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">3 Easy Ways To Make Your iPhone Faster
                    </li>
                </ol>
            </nav>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="post post-single">
                        ...
                        <div class="post-content clearfix">
                            ...
                            <p>Everyone realizes why a new common language would be desirable: one could refuse to
                                pay expensive translators. To achieve this, it <mark>would be</mark> necessary to
                                have uniform grammar, pronunciation and more common words.</p>

                            <figure class="figure">
                                <img src="{{ asset('') }}assets/images/posts/post-lg-2.jpg"
                            ...
                            <img src="{{ asset('') }}assets/images/posts/single-sm-1.jpg" class="rounded alignleft"
                                alt="...">
                            <p>One could refuse to pay expensive translators. To achieve this, it would be necessary
                                to have uniform grammar, pronunciation and more common words.</p>
                            ...
                            <p>If several languages coalesce, the grammar of the resulting language is more simple
                                ...
                                more simple and regular than the existing <a href="#">European languages</a>.
                            ...
                            <p>To an English person, it will seem like simplified <a href="#">English</a>, as
